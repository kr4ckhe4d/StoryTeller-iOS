...
-(id)initWithViews:(NSArray*)images storydata:(NSArray *)storydata{
    ...
    if (self) {
        ...
        svrect_.size.height = self.view.bounds.size.height-60;
...
//        UIImage* fill = createImageFromUIColor([UIColor colorWithWhite:0.9 alpha:1]);
        ...
        backButton = [[UIButton alloc] initWithFrame:CGRectMake(5, 0, 35, 30)];
        [backButton setImage:[UIImage imageNamed:@"backButton"] forState:UIControlStateNormal];
        [self.view addSubview:backButton];
        [backButton addTarget:self
                        action:@selector(dismisStory:)
...
-(void)dismisStory:(UIButton *)sender{
